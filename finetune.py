...
add_arg("mse_whisper", type=float, default=0,    help="loss combination")
add_arg("ctc", type=float, default=0,    help="loss combination")
...
model.brain_module.pre_layer.initial_linear.register_forward_hook(make_inputs_require_grad)
...
if args.trainable_brainmodule:
    ...
    for theta in model.thetas:
        for param in theta.parameters():
            param.requires_grad=True
    for param in model.jmmd_loss.parameters():
        param.requires_grad=True
