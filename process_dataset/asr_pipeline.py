...
# python process_dataset/asr_pipeline.py --input_dir="/mnt/petrelfs/zhangchi1/datasets/Gwilliams2023/download/stimuli/audio"
# --output_dir="/mnt/petrelfs/zhangchi1/datasets/Gwilliams2023/preprocess/audio"
...
if __name__ == '__main__':
    ...
    if args.backend=='whisper':
        ...
        # import pdb;pdb.set_trace()
        model = whisperx.load_model("large-v2", 'cuda', compute_type=compute_type, language='en')
    else:
