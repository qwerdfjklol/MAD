...
class GPTTextEnhancer:
    def __init__(self, client='/mnt/petrelfs/zhangchi1/m2t/data_augmentation_utils/config/key.json', model='gpt-3.5-turbo', resp_kwargs=None,mid_lang='german'):
...
class TextAug:
    def __init__(self,client='/mnt/petrelfs/zhangchi1/m2t/data_augmentation_utils/config/key.json', model='gpt-3.5-turbo', resp_kwargs=None):
